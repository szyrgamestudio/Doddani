...
//=============================================================================
 /*:
 * @plugindesc v1.07 Substitue o comando padrão 'Formation' com um novo
 * menu para jogadores mudarem facilmente as formações da party.
 ...
 * @desc Número máximo de personagens que podem participar em batalha.
 * Padrão: 4
 * @default 4
 *
 * @param Show Battle Command
 * @desc Mostrar o comando 'Formation' na Janela de Comando da Party?
 * NÃO - false     SIM - true
 * @default true
 *
 * @param Enable Battle Command
 * @desc Habilitar o comando 'Formation' na Janela de Comando da Party?
 * NÃO - false     SIM - true
 * @default true
 *
 * @param Battle Cooldown
 * @desc Quantas rodadas o jogador deve esperar depois de
 * trocar de party?
 * @default 1
 *
 ...
 *
 * @param Help Window
 * @desc Mostrar a Janela de Ajuda no menu da party?
 * NÃO - false     SIM - true
 * @default true
 *
 * @param Text Alignment
 * @desc O alinhamento de texto na janela de comando.
 * left     center     right
 * @default center
 *
 * @param Change Command
 * @desc Como o comando 'Change' apareçe no menu de comando.
 * @default Change
 *
 * @param Remove Command
 * @desc Como o comando 'Remove' apareçe no menu de comando.
 * @default Remove
 *
 * @param Revert Command
 * @desc Como o comando 'Revert' apareçe no menu de comando.
 * @default Revert
 *
 * @param Finish Command
 * @desc Como o comando 'Finish' apareçe no menu de comando.
 * @default Finish
 *
 * @param ---Selection---
 * @default
 *
 * @param Empty Text
 * @desc Qual texto a ser exibido no slot vazio da party.
 * @default - Empty -
 *
 * @param Actor Face
 * @desc Mostrar a face do personagem?
 * NÃO - false     SIM - true
 * @default true
 *
 * @param Actor Sprite
 * @desc Mostrar o sprite do personagem?
 * NÃO - false     SIM - true
 * @default true
 *
 * @param ---List---
 ...
 *
 * @param Remove Text
 * @desc O texto usado para mostrar o comando "Remove" na lista de
 * membros da party.
 * @default Remove
 *
 * @param Remove Icon
 * @desc O ícone usado para mostrar próximo do comando "Remove"
 * na lista de membros da party.
 * @default 16
 *
 * @param Sprite Y Buffer
 * @desc Essa é a quantia para ajustar o gráfico do personagem por.
 * @default 16
 *
 * @param In Party Text Color
 * @desc Esse é a cor de texto usada se o personagem está atualmente na
 * party.
 * @default 6
 *
 * @param ---Locking---
 ...
 * @desc Permite que você trave o primeiro personagem no jogo por padrão.
 * DESLIGADO - false     LIGADO - true
 * @default false
 *
 * @param Locked Icon
 * @desc Isso estabelece qual ícone a ser usado quando um personagem
 * for bloqueado.
 * @default 195
 *
 * @param Required Icon
 ...
 * @desc Faz uso da janela detalhada da party próximo da lista.
 * NÃO - false     SIM - true
 * @default true
 *
 * @param List Width
 * @desc Se a janela detalhada for habilitada, qual é a largura da
 * lista de party?
 * @default 300
 *
 * @param Actor Parameters
 * @desc Se há espaço suficiente, esse é o texto usado para listar os
 ...
 * ============================================================================
 *
 * Esse plugin substitue o comando "Formation" achado dentro do menu do jogo
 * com uma nova cena onde o jogador pode ajustar a party que ele quiser de uma
 * forma mais intuitiva.
 *
 * Se você estiver usado YEP_BattleEngineCore.js e quiser habilitar a troca
 * de party no meio da batalha, coloque este plugin abaixo do
 * YEP_BattleEngineCore.js na lista de plugin.
 *
 * Para este plugin, tudo que você tem que fazer é ligá-lo e mudar os
 * parâmetros ao seu gosto.
 *
 * ============================================================================
 * Comandos de Plugin
 * ============================================================================
 *
 * Aqui está alguns comandos de plugin que você pode usar.
 *
 * Comando de Plugin:
 *   OpenPartyMenu     Abre o Menu da Party pelo mapa.
 *
 * Personagens podem ser necessários, que significa que o jogador deve ter
 * o(s) personagem(s) na party antes de for capaz de sair do menu
 * da party. Personagens necessários podem ser movidos, diferentemente dos
 * personagens travados. Tenha em mente que se você fizer alguns personagens
 * necessários, não faça o jogo requerer mais personagens que a quantidade
 * máxima possível de membros de batalha ou senão o jogador ficará preso
 * no menu da party.
 *
 * Comando de Plugin:
 *   ShowBattleFormation    - Mostra o comando 'Formation' em batalha.
 *   HideBattleFormation    - Esconde o comando 'Formation' em batalha.
 *   EnableBattleFormation  - Habilita o comando 'Formation' em batalha.
 *   DisableBattleFormation - Desabilita o comando 'Formation' em batalha.
 *
 *   LockActor 3          - Trava personagem 3.
 *   LockActor 4 5 6      - Trava personagem 4, 5, e 6.
 *   UnlockActor 3        - Destrava personagem 3.
 *   UnlockActor 4 5 6    - Destrava personagem 4, 5, e 6.
 *                        * Personagens travados não podem ser movidos fora
 *                          de sua posição atual e devem estar na party.
 *
 *   RequireActor 3       - Jogador deve ter personagem 3 na party.
 *   RequireActor 4 5 6   - Jogador deve ter personagens 4, 5, e 6 na party.
 *   UnrequireActor 3     - Jogador não precisa mais de ter personagem 3 na
 *                          party.
 *   UnrequireActor 4 5 6 - Jogador não precisa mais de ter personagem 4, 5, e
 *                        * 6 na party. Personagens necessários devem estar na
 *                          party para o jogador seja capaz de sair do menu da
 *                          party.
 *
